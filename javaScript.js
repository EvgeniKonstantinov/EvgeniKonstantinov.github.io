...
var feed=new ody({
    ...
    '<img class="insta_img" src="https://lh3.googleusercontent.com/-P-gOTAfNfZ4/V2RPSYvECxI/AAAAAAAABng/Efqy2Oxjqm4lrmDhT07PBtlgYRb_MlJ7QCCo/s576/questyerror.png"> </img>' +
    '<div class="instagrid-z">' +
    '<div class="instagrids">' +
    '<span class="instagrid-outter">{{likes}} ' +
    '<i class="fa fa-heart"></i><br/>{{comments}} ' +
...
$(window).scroll(function () {
    ...
    if ( bo > 700 ) { $("nav").css("display", "block"); } else { $("nav").css("display", "none"); };
